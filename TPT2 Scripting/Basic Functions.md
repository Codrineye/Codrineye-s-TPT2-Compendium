...
```
For ease of use, I prefer to put the package source before updating the code

## Package Source goes here

I recommend creating a new workspace for packages so you can delete your workspace instead of deleting the scripts 1 by 1

## Workspace Name
{


I prefer to keep a single .txt file when scripting so I can look at other spots I worked in and used this function
